...
!(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? (module.exports = e()) : "function" == typeof define && define.amd ? define(e) : ((t = "undefined" != typeof globalThis ? globalThis : t || self).minCounter = e());
})(this, function () {
    "use strict";
    return (function (t) {
        if (typeof window === "undefined" ? null : window) {
                ...
                i = function (t, i) {
                    if (t.getAttribute("minlength")) {
                        ...
                        var o = !0,
                            s = function () {
                                var e,
                                    n = null != (e = t.getAttribute("minlength")) ? parseInt(e, 10) : null,
                                    i = t.value.length < n;
                                i &&
                                    (function (e) {
                                ...
                                var s,
                                    u = t.value.length,
                                    l =
                                        ((s = { minlength: n, length: u, remaining: n - u }),
                                        a.replace(/(?:{([a-zA-Z]+)})/g, function (t, e) {
                                            return s[e];
                                        }));
                               r.updateText(l), o ? (o = !1) : r.updateAssist(l, i);
                            };
                        t.addEventListener("focus", r.syncAssist), t.addEventListener("blur", r.resetAssist), t.addEventListener("input", s), s();
                    }
                },
                a = {
                    counterClassName: "counter-display",
                    counterLabel: "{length} of {minlength} minimum characters",
                    assistDelay: 2e3,
                    append: function (t, e) {
            ...
            return function (t, e) {
                return "string" == typeof t ? r(((n = document.querySelectorAll(t)), Array.prototype.slice.call(n)), e) : r([t], e)[0];
                var n;
            };
        }
    })();
