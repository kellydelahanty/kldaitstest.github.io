...
$shamrock-light: #EDF7F1;
$shamrock-mid:#3A985D;
$shamrock-dark:#0B7452;
...
$inky: #051e35;
$carolina: #B0DBFD;
$smoked-7: #08568B; //toggle switch color
...
$blue-gray-light: #C8DBE9;
$blue-gray-mid: #829FB6;

$blue-gray-dark: #445870;
...
$alert-lightest: #FEECEC;
$alert-light: #FFC3C2;
$alert-dark: #B82025;
$alert-darkest: #780B0B;
...
//Functional Colors - ADD TO MAIN CSS
$error: $alert-dark;

$success-light: $shamrock-light;
$success-mid: $shamrock-mid;
$success-dark: $green-6;

$form-color: $sea-6;
$form-outline: $medium-gray;
...
$button-background-hover: scale-color($button-background, $lightness: -30%);
$button-color: $white;
