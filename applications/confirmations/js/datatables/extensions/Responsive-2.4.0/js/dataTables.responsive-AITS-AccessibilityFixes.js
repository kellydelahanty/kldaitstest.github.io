...
$.extend( Responsive.prototype, {
	...
	_tabIndexes: function ()
	{
		...
		//AITS Accessibility Fix (if statement not in original code). Show tab indexes on data table only when it in responsive state, otherwise hide them
		if( $(cells).parent().parent().parent().hasClass("collapsed") ){
		...
		//AITS Accessibility Fix (else statement and all code within not in original code)
		else {
			if ( typeof target === 'number' ) {
				dt.cells( null, target, { page: 'current' } ).nodes().to$()
					.removeAttr( 'tabIndex' )
